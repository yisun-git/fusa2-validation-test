...
static __unused void safety_analysis_rqmid_33885_mitigation_Spatial_Interface_Memory_isolation_direct_access_002(void)
{
...
static __unused void print_case_list(void)
{
	...
	"mitigation-Spatial Interface_Memory isolation - direct access_002");
}
...
int main(void)
{
	...
	printf("\n boot_idt=%p %s\n", boot_idt, __FILE__);
	safety_analysis_rqmid_33885_mitigation_Spatial_Interface_Memory_isolation_direct_access_002();

...
struct cache_data cache_bench[CACHE_SIZE_TYPE_MAX] = {
	[CACHE_L1_READ_WB] = {2561UL, 12UL},
	[CACHE_L2_READ_WB] = {19426UL, 27UL},
	[CACHE_L3_READ_WB] = {675312UL, 697UL},
	[CACHE_OVER_L3_READ_WB] = {3666816UL, 32812UL},
	[CACHE_L1_WRITE_WB] = {2557UL, 4UL},
	[CACHE_L2_WRITE_WB] = {21826UL, 25UL},
	[CACHE_L3_WRITE_WB] = {771848UL, 47UL},
	[CACHE_OVER_L3_WRITE_WB] = {5746691UL, 104890UL},
	[CACHE_L1_READ_WC] = {434172UL, 23598UL},
	[CACHE_L2_READ_WC] = {3475688UL, 29965UL},
	[CACHE_L3_READ_WC] = {111239155UL, 32322UL},
	[CACHE_OVER_L3_READ_WC] = {444958335UL, 55283UL},
	[CACHE_L1_WRITE_WC] = {2846UL, 139UL},
	[CACHE_L2_WRITE_WC] = {28765UL, 8351UL},
	[CACHE_L3_WRITE_WC] = {933230UL, 21550UL},
	[CACHE_OVER_L3_WRITE_WC] = {3732738UL, 25788UL},
	[CACHE_L1_READ_WT] = {2559UL, 10UL},
	[CACHE_L2_READ_WT] = {19427UL, 22UL},
	[CACHE_L3_READ_WT] = {675398UL, 785UL},
	[CACHE_OVER_L3_READ_WT] = {3666305UL, 30675UL},
	[CACHE_L1_WRITE_WT] = {337804UL, 74UL},
	[CACHE_L2_WRITE_WT] = {2701255UL, 115UL},
	[CACHE_L3_WRITE_WT] = {86441555UL, 539UL},
	[CACHE_OVER_L3_WRITE_WT] = {345766819UL, 857UL},
	[CACHE_L1_READ_WP] = {2558UL, 11UL},
	[CACHE_L2_READ_WP] = {19427UL, 23UL},
	[CACHE_L3_READ_WP] = {675305UL, 758UL},
	[CACHE_OVER_L3_READ_WP] = {3667103UL, 26090UL},
	[CACHE_L1_WRITE_WP] = {337783UL, 77UL},
	[CACHE_L2_WRITE_WP] = {2701298UL, 146UL},
	[CACHE_L3_WRITE_WP] = {86441470UL, 630UL},
	[CACHE_OVER_L3_WRITE_WP] = {345766652UL, 1069UL},
	[CACHE_L1_READ_UC] = {434897UL, 23592UL},
	[CACHE_L2_READ_UC] = {3475375UL, 28866UL},
	[CACHE_L3_READ_UC] = {111238055UL, 27749UL},
	[CACHE_OVER_L3_READ_UC] = {444954060UL, 37009UL},
	[CACHE_L1_WRITE_UC] = {337809UL, 84UL},
	[CACHE_L2_WRITE_UC] = {2701305UL, 137UL},
	[CACHE_L3_WRITE_UC] = {86441465UL, 531UL},
	[CACHE_OVER_L3_WRITE_UC] = {345766603UL, 979UL},
	[CACHE_DEVICE_4K_READ] = {2136918UL, 1301UL},
	[CACHE_DEVICE_4K_WRITE] = {1676833UL, 68UL},
	[CACHE_L1_READ_UC_NOFILL] = {4260749UL, 27829UL},
	[CACHE_L2_READ_UC_NOFILL] = {34043679UL, 23529UL},
	[CACHE_L3_READ_UC_NOFILL] = {1090589173UL, 484151UL},
	[CACHE_OVER_L3_READ_UC_NOFILL] = {4363625006UL, 1824003UL},
	[CACHE_L1_WRITE_UC_NOFILL] = {4814373UL, 24998UL},

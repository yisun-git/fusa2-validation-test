...
#define FW_CFG_SAFETY_VM_CORE_NUMS      1
#define FW_CFG_NATIVE_CORE_NUMS         4
#define FW_CFG_OTHERS_CORE_NUMS         3

#ifdef IN_SAFETY_VM
#define UT_CORE_NUMS	FW_CFG_SAFETY_VM_CORE_NUMS
#elif defined IN_NATIVE
#define UT_CORE_NUMS	FW_CFG_NATIVE_CORE_NUMS
#else
#define UT_CORE_NUMS	FW_CFG_OTHERS_CORE_NUMS
#endif
